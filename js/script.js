...
let weatherAPIKey = '2b9c5f98c8519a4aea96be0413b11b39';
...
let init = () => {
    weatherForCity('Accra').then(() => document.body.style.filter = 'blur(0)');
}
init();
...
let updateForecast = (forecast) => {
    ...
    forecast.forEach(day => {
        ...
        let forecastItem = `
                ...
                <p class="weather_forecast_temperature"><span class="value">${temperature}</span>
                    &deg;C</p>
                </article>
        `;
